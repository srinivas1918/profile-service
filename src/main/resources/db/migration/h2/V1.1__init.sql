CREATE TABLE IF NOT EXISTS `CRS_CUSTOMER` (
...
CREATE TABLE IF NOT EXISTS `CRS_VENDOR` (
...
CREATE TABLE IF NOT EXISTS `CRS_LOCATONS` (
...
CREATE TABLE IF NOT EXISTS `CRS_CARS` (
